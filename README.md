...
As an alternative, we recommend trying our lightweight music bot, [Alastor](https://github.com/EylDUyX0gcxJI8/discord-bot-alastor/pkgs/container/discord-bot-alastor). This bot streams music directly from public web-radio streams, ensuring reliable playback without the need for additional integrations.
...
```sh
git clone https://github.com/EylDUyX0gcxJI8/discord-bot-evomusic  # Clone the forked repository
...
```shell
docker run -e TOKEN=your_discord_bot_token -e SPOTIFY_CLIENT_ID=your_spotify_client_id -e SPOTIFY_CLIENT_SECRET=your_spotify_client_secret ghcr.io/EylDUyX0gcxJI8/discord-bot-evomusic:latest -d
```
...
1. Clone your fork: `git clone https://github.com/EylDUyX0gcxJI8/discord-bot-evomusic.git`
